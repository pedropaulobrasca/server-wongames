...
async function createManyToManyData(products) {
    ...
    products.forEach((product) => {
        ...
        genres === null || genres === void 0 ? void 0 : genres.forEach((item) => {
            categories.add(item);
        });
        supportedOperatingSystems === null || supportedOperatingSystems === void 0 ? void 0 : supportedOperatingSystems.forEach((item) => {
            platforms.add(item);
        });
...
async function setImage({ image, game, field = "cover" }) {
    try {
        ...
        console.log("🖼️ setImage", Exception(e));
    }
}
